...
import ArmWorkoutDatas from '../../../Models/Training/ArmWorkoutData';
...
const getArmsPerMonth = async (profileId: ObjectId | string) => {
  try {
    ...
    const response = await ArmWorkoutDatas.aggregate([
      {
        $match: {
...
export default armsProgressionService;
